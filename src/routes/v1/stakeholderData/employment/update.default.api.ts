...
export const Errors = {
  ...
  EmploymentOrgChangingErrorHasActualShifts: errors.EmploymentOrgChangingErrorHasActualShifts,
  EmploymentDateFromToChangingErrorHasActualShifts: errors.EmploymentDateFromToChangingErrorHasActualShifts,
};
